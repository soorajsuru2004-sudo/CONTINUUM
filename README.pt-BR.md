...
O CONTINUUM é uma biblioteca (`src/continuum`, 124 módulos) mais uma suíte de testes grande (161 arquivos de teste, ~2,402 testes). Todos os módulos acrescentam e reproduzem um log de eventos encadeado:
